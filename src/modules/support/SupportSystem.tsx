                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-gray-50/30">
                            ...
                            <div className="flex gap-3 max-w-[80%]">
                                ...
                                <div className="bg-white border border-gray-100 p-4 rounded-2xl rounded-tl-none shadow-sm">
                                    <p className="text-sm text-gray-700 leading-relaxed">Hello, I'm having trouble with my recent booking for the "Summer Music Fest". The payment went through but I haven't received my ticket yet.</p>
                            ...
                            <div className="flex gap-3 max-w-[80%] ml-auto flex-row-reverse">
                                <div className="bg-slate-900 text-white p-4 rounded-2xl rounded-tr-none shadow-md">
                                    <p className="text-sm leading-relaxed">Hi {selectedChat.user.split(' ')[0]}, I'm sorry to hear that. Let me check your transaction status right away. Could you please provide your booking ID?</p>
                            ...
                            <div className="flex gap-3 max-w-[80%]">
                                <img src={selectedChat.avatar} className="w-8 h-8 rounded-full object-cover mt-1" alt="" />
                                <div className="bg-white border border-gray-100 p-4 rounded-2xl rounded-tl-none shadow-sm">
                                    <p className="text-sm text-gray-700 leading-relaxed">Sure, it's #BK-98231.</p>
                        ...
                        <div className="p-4 bg-white border-t border-gray-100">
                            <div className="flex gap-3">
                                ...
                                <div className="flex-1 relative">
                                    <input type="text" placeholder="Type your message..." className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all" />
                                </div>
                                <button className="px-6 py-3 bg-yellow-400 text-gray-900 font-bold rounded-xl hover:bg-yellow-500 shadow-md shadow-yellow-400/20 transition-all">Send</button>
                            </div>
                        </div>
                    </>
                ) : (
